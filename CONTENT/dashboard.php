                  ...
                  <tbody>
                    ...
                    foreach($userList as $user){
                      if($user['role'] == 0){
                       ...
                       echo '<td> <a  href = "../userLogic/advancedAdmin.php?id='.$user['userID'].'">Advance to Admin</a> </td>';
                       echo '<td name="editId"><a onclick="showForm('.$count++.')">Edit</a> </td>';
                       echo '<td> <a href = "../userLogic/deleteUser.php?id='.$user['userID'].'">Delete User</a></td>';
                       echo '</tr>';
